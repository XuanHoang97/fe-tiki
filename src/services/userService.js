...
const createNewProduct = (data) => {
    return axios.post(`http://localhost:8082/api/create-new-product`, data)
}

// edit product
const editProduct = (inputData) => {
    return axios.put(`http://localhost:8082/api/edit-product`, inputData)
}

//delete product
const deleteProduct = (productId) => {
    return axios.delete(`http://localhost:8082/api/delete-product`, {
        data: {
            id: productId
        }
    })
...
const editInfoProduct = (inputData) => {
    return axios.put(`http://localhost:8082/api/edit-info-product`, inputData)
}

//get some product
const getSomeProduct = (productId) => {
    return axios.get(`http://localhost:8082/api/get-some-product?id=${productId}`)
}

//get all article
const getAllArticle = (articleId) => {
    return axios.get(`http://localhost:8082/api/get-article-product?id=${articleId}`)
}
...
const createCategory = (data) => {
    return axios.post(`http://localhost:8082/api/create-new-category`, data)
}

//edit category
const editCategory = (inputData) => {
    return axios.put(`http://localhost:8082/api/edit-category`, inputData)
}

//delete category
const deleteCategory = (categoryId) => {
    return axios.delete(`http://localhost:8082/api/delete-category`, {
        data: {
            id: categoryId
        }
    })
...
const createNews = (data) => {
    return axios.post(`http://localhost:8082/api/create-news`, data)
}

//edit news and event
const editNews = (inputData) => {
    return axios.put(`http://localhost:8082/api/edit-news`, inputData)
}

//delete news and event
const deleteNews = (newsId) => {
    return axios.delete(`http://localhost:8082/api/delete-news`, {
        data: {
            id: newsId
        }
    })
...
const getAllSlides = (slideId) => {
    return axios.get(`http://localhost:8082/api/get-all-slide?id=${slideId}`)
}

//create new slides
const createSlides = (data) => {
    return axios.post(`http://localhost:8082/api/create-slide`, data)
}

//edit slides
const editSlides = (inputData) => {
    return axios.put(`http://localhost:8082/api/edit-slide`, inputData)
}

//delete slides
const deleteSlides = (slidesId) => {
    return axios.delete(`http://localhost:8082/api/delete-slide`, {
        data: {
            id: slidesId
        }
    })
...
const getAllSpecialCategory = (specialCategoryId) => {
    return axios.get(`http://localhost:8082/api/get-all-specialCategory?id=${specialCategoryId}`)
}

// create new special category
const createSpecialCategory = (data) => {
    return axios.post(`http://localhost:8082/api/create-specialCategory`, data)
}

// edit special category
const editSpecialCategory = (inputData) => {
    return axios.put(`http://localhost:8082/api/edit-specialCategory`, inputData)
}

//delete special category
const deleteSpecialCategory = (specialCategoryId) => {
    return axios.delete(`http://localhost:8082/api/delete-specialCategory`, {
        data: {
