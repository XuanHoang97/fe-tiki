...
class ModalUser extends Component {
    ...
    handleAddNewUser=()=>{
        ...
        console.log('add new data: ', this.state);
    }
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <ModalHeader toggle={()=>this.toggle()}>{this.state.action===CRUD_ACTIONS.EDIT ? 'Cập nhật thành viên' : 'Thêm mới thành viên' }</ModalHeader>
                <ModalBody>
                        <form>
                            <div className="row">
                                    ...
                                    >
                                        {
                                            ...
                                            genderArr.map((item, index) => {
                                                return (
                                                    <option key={index} value={item.ValueEn}>{item.valueVi}</option>
                                                )
                                            })
                                        }           
                                    </select>
                ...
                <ModalFooter>
                    <Button onClick={()=>this.handleAddNewUser()} color="primary" className="px-3">
                        {this.state.action===CRUD_ACTIONS.EDIT ? 'Cập nhật' : 'Thêm mới' }
                    </Button>
